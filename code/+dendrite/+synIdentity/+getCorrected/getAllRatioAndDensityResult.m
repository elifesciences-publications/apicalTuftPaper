...
synRatio.uc.l235 = apicalTuft.applyMethod2ObjectArray...
    ...
    'mapping');
synDensity.uc.l235 = ...
    dendrite.l2vsl3vsl5.combineL5AwithLPtATable(synDensity.uc.l235);
synRatio.uc.l235 = ...
    dendrite.l2vsl3vsl5.combineL5AwithLPtATable(synRatio.uc.l235);

%% Datasets within L2: small datasets containing the main bifurcation
% annotations in L2
[results] = ...
    dendrite.synIdentity.getCorrected.smallDatasets(skel,synRatio,synDensity);
...
% of ADs
[results] = ...
    dendrite.synIdentity.getCorrected.LargeDatasets(skel,...
